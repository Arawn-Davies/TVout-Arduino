...
## Foreword
I'm not the original developer of this library, you can find the original archived repo of this library at https://code.google.com/archive/p/arduino-tvout/, but this repo is outdated and read-only.

You may find other repos on GitHub which contain this library but some of them are a bit complex over how the project is organised.
